About certbot-dns-google-feedstock
==================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/certbot-dns-google-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/certbot-dns-google-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add certbot-dns-google
# for installing globally
pixi global install certbot-dns-google
```
...
It is possible to list all of the versions of `certbot-dns-google` available on your platform:
...
```
pixi search certbot-dns-google --channel conda-forge
```
